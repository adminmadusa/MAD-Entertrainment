/**
 * TEST-001 — confirmBooking Transaction Integration Tests: Rollback, Late Recovery & Integrity
 *
 * Governance:
...
describe('TEST-001 — confirmBooking Transaction Integration (Rollback & Integrity)', () => {
  beforeEach(() => {
    vi.clearAllMocks();
