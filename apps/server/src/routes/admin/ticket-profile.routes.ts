...
router.post(
  "/",
  validate(createTicketProfileSchema),
  ticketProfileController.createTicketProfile,
);
router.get("/", ticketProfileController.getTicketProfiles);
router.get("/:id", ticketProfileController.getTicketProfileById);
router.put(
  "/:id",
  validate(updateTicketProfileSchema),
  ticketProfileController.updateTicketProfile,
);
