...
const AuthController = __importStar(require("../../controllers/public/auth.controller"));
...
exports.authRouter.get('/me', auth_middleware_1.requireAuth, AuthController.getMe);
