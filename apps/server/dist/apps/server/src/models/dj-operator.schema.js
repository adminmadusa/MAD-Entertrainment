...
const djOperatorSchema = new mongoose_1.Schema({
    ...
    socialLinks: [
        new mongoose_1.Schema({ platform: { type: String, required: true }, url: { type: String, required: true } }, { _id: false }),
    ],
    isActive: { type: Boolean, default: true, index: true },
}, { timestamps: true });
exports.DJOperator = mongoose_1.default.models.DJOperator ||
    mongoose_1.default.model('DJOperator', djOperatorSchema);
