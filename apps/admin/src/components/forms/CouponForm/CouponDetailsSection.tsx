...
export function CouponDetailsSection({ values, onFieldChange }: CouponDetailsSectionProps) {
  return (
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FormField label="Discount Type">
          ...
          >
            ...
            <option value="free_ticket" className="bg-background-card">Free Ticket</option>
          </select>
        </FormField>
      </div>
