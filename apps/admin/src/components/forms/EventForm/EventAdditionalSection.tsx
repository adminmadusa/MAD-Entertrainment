    ...
    <FormSection title="Additional Details">
      <div className="grid grid-cols-2 gap-4">
        <FormField label="Organizer Name">
          <input
            ...
            onChange={(e) => onFieldChange("organizerName", e.target.value)}
            className={inputCls}
          />
        </FormField>
        <FormField label="Highlights (comma separated)">
          <input
            ...
            onChange={(e) => onFieldChange("highlightsInput", e.target.value)}
            className={inputCls}
          />
        </FormField>
      </div>
      <FormField label="Refund Policy">
        <textarea
          ...
          onChange={(e) => onFieldChange("refundPolicy", e.target.value)}
          rows={2}
