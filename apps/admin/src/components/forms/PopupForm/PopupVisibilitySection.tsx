...
export function PopupVisibilitySection({
  values,
  onFieldChange,
        ...
        <FormField label="Trigger Type">
          <select
            ...
            onChange={(e) =>
              onFieldChange(
                "trigger",
                e.target.value as PopupFormValues["trigger"],
              )
            }
            className={POPUP_INPUT_CLASSNAME}
          >
            <option value="on_load" className="bg-background-card">
              On Load
            </option>
            <option value="after_delay" className="bg-background-card">
              After Delay
            </option>
            <option value="on_exit" className="bg-background-card">
              Exit Intent
            </option>
            <option value="on_scroll" className="bg-background-card">
              Scroll Percentage
            </option>
          </select>
        </FormField>
