...
const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Ticket Profiles",
        href: "/ticket-profiles",
        icon: <TicketIcon />,
      },
                ...
                if (item.disabled) {
                  return (
                    <li key={item.href}>
                      <div
                        title={
                          collapsed ? `${item.label} (Coming Soon)` : undefined
                        }
                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      className={[
                        "flex items-center gap-3 px-2 py-2.5 rounded-xl transition-colors duration-150 group relative",
                        active
