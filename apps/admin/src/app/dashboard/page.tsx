...
export default function AdminDashboardPage() {
  ...
  const quickLinks = [
    ...
    },
    {
      ...
      href: "/bookings",
      icon: "🎟️",
      color: "border-border-subtle hover:border-white/20",
    },
    {
    ...
    <div className="space-y-8">
      ...
      >
        ...
        <p className="text-text-muted text-sm mt-1">
          Here&apos;s what&apos;s happening with MAD Entertrainment.
        </p>
      </motion.div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
        {stats.map((stat, i) => (
          ...
          >
            <Link
              href={stat.href}
              className="block glass rounded-2xl border border-border-subtle p-6 hover:border-accent-purple/30 transition-colors group"
            >
