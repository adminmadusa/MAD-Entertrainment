        ...
        {isInviteOpen && (
          <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4 sm:p-6 overflow-y-auto">
            <motion.div
              ...
              className="glass-strong rounded-2xl border border-border-subtle p-4 sm:p-6 max-w-md w-full space-y-4 my-auto max-h-[90vh] overflow-y-auto"
            >
              <div>
              ...
              <form onSubmit={handleInviteSubmit} className="space-y-4">
                ...
                <div className="flex flex-col-reverse sm:flex-row gap-3 pt-2">
                  ...
                  <button
                    ...
                    className="flex-1 py-2.5 btn-gradient text-white font-bold rounded-xl shadow-glow-sm disabled:opacity-60 transition-colors motion-reduce:transition-none text-sm"
                  >
