...
describe("forms/scheduling", () => {
  it("converts ISO to local datetime input format", () => {
    expect(toLocalDateTimeInput("2026-01-01T10:30:00.000Z")).toMatch(
  ...
  it("validates date ranges", () => {
    expect(validateDateRange("2026-01-01T10:00", "2026-01-01T12:00")).toBe(
      true,
    );
    expect(validateDateRange("2026-01-01T12:00", "2026-01-01T10:00")).toBe(
      false,
    );
  });
