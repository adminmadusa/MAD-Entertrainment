              ...
              >
                ...
                >
                  ...
                  <div className="p-5 flex flex-col flex-grow">
                    ...
                    <h3 className="text-white font-bold text-base line-clamp-1 mb-2 group-hover:text-accent-purple-light transition-colors">
                      {event.title}
                    </h3>
  ...
  return (
    <Suspense fallback={
      <div className="pt-28 pb-16 min-h-screen bg-background flex items-center justify-center">
        <div className="text-white/40 animate-pulse text-sm">Loading events...</div>
      </div>
    }>
      <EventsList />
    </Suspense>
