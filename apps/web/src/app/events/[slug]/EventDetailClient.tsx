      ...
      {lightboxIndex !== null && event.galleryImages && event.galleryImages[lightboxIndex] && (
        <div className="fixed inset-0 bg-black/95 z-[200] flex flex-col items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-4xl h-[70vh]">
            {event.galleryImages[lightboxIndex].url && (
              <Image
                src={event.galleryImages[lightboxIndex].url}
                alt={event.galleryImages[lightboxIndex].alt || 'Event Gallery Detail'}
                fill
                sizes="100vw"
          ...
          {event.galleryImages.length > 1 && (
            <div className="flex gap-6 mt-6 items-center">
              ...
              <button
                onClick={() =>
                  setLightboxIndex((prev) =>
                    prev !== null ? (prev + 1) % event.galleryImages!.length : null
                  )
                }
                className="w-12 h-12 bg-white/10 hover:bg-white/20 rounded-full flex items-center justify-center text-white text-lg font-bold transition-colors"
              >
