  ...
  if (isLoading) {
    gridContent = (
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
        {[1, 2, 3, 4, 5, 6, 7, 8].map((n) => (
          <div
            key={n}
            className="rounded-2xl border border-border-subtle overflow-hidden glass animate-pulse"
          >
    ...
    gridContent = (
      <div className="text-center py-20 glass rounded-2xl border border-border-subtle">
        <div
          className="flex justify-center mb-4 text-accent-purple/60"
          aria-hidden="true"
        >
          <svg
            className="w-14 h-14"
