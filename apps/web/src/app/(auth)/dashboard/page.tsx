  ...
  return (
    <div className="glass rounded-3xl border border-border-subtle p-6 sm:p-8 space-y-6 animate-pulse">
      ...
      <div className="border-t border-border-subtle/30 pt-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div className="space-y-1.5"><div className="w-20 h-2.5 bg-white/5 rounded" /><div className="w-40 h-4 bg-white/10 rounded" /></div>
        <div className="space-y-1.5"><div className="w-20 h-2.5 bg-white/5 rounded" /><div className="w-40 h-4 bg-white/10 rounded" /></div>
      </div>
    </div>
  );
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 pb-2">
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        <Link
                          ...
                          className="px-4 py-2 border border-white/10 hover:bg-white/5 rounded-xl text-text-secondary hover:text-white text-xs font-bold transition-all inline-flex items-center justify-center shrink-0"
                        >
                          View Details →
                        </Link>
                      </div>
