                      ...
                      <div className="flex flex-wrap gap-2">
                        {bookingTicketsReady && (
                          <TicketActions
                            ...
                            onShare={() => handleShare(booking.bookingId)}
                          />
                        )}
                      </div>
                    </div>
    ...
    <div className="pt-20 sm:pt-28 pb-16 min-h-screen bg-background relative overflow-hidden">
      ...
      <div className={`container-mad max-w-3xl relative z-10 px-4 space-y-8${stickyBarVisible ? ' pb-28 sm:pb-0' : ''}`}>
        ...
        {showSkeleton ? (
          ...
          <div className="space-y-8">
            {/* Stateful Glassmorphic Segmented Control Tab Bar — Change 4: ARIA tab roles */}
            <div
              role="tablist"
              aria-label="Dashboard navigation"
              className="glass p-1.5 rounded-2xl border border-white/5 flex gap-1 w-full sm:w-max"
            >
              <button
                type="button"
                role="tab"
            ...
            {/* Active Tab View — Change 4: tabpanel role/id/aria-labelledby */}
            <div className="space-y-6">
              {activeTab === 'tickets' && (
