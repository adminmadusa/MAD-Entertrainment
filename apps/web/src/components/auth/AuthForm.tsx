    ...
    <div className={`space-y-4 sm:space-y-6 relative ${className}`}>
      {onClose && (
        <button
          type="button"
          onClick={handleClose}
          className="absolute top-3 right-3 text-white hover:text-white/80 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-purple rounded-md min-h-[44px] min-w-[44px] z-50 transition-all flex items-center justify-center"
          aria-label="Close"
        >
