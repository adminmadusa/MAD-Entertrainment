...
export function MarqueeBanner({
  ...
  return (
    <section
      className="py-8 overflow-hidden border-y border-border-subtle bg-background-secondary/50"
      aria-hidden="true"
    >
      <div className="flex items-center animate-marquee whitespace-nowrap">
        {items.map((item, i) => (
          <span
            key={i}
            className="mx-8 text-text-muted text-sm font-semibold uppercase tracking-widest inline-flex items-center gap-2"
          >
            {item}
