...
export type TicketTierWithOptionalFields = EventData['ticketTiers'][number] & {
  groupName?: string;
  isFree?: boolean;
  offerRules?: {
...
export function TicketTierList({
  ...
  const groupedTiers = ticketTiers.reduce<Record<string, TicketTierWithOptionalFields[]>>((acc, tier) => {
