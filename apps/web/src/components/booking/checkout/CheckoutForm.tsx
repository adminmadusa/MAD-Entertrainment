...
export function CheckoutForm({
  ...
  const handlePlaceOrderSubmit = (e: React.FormEvent) => {
    ...
    if (guestEmailConfirm !== guestEmail)
      ...
      <div className="glass rounded-2xl border border-white/5 p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div className="space-y-1">
            ...
            />
            {fieldErrors.lastName && (
              <p className="text-red-400 text-[10px]">{fieldErrors.lastName}</p>
            )}
          </div>
        </div>
          ...
          <div className="space-y-1 flex flex-col justify-between">
            ...
            {(fieldErrors.birthMonth ||
              ...
              <p className="text-red-400 text-[10px] mt-1">
                Valid birthdate is required (Age 18+)
              </p>
            )}
          </div>
        </div>
