...
export const drawerContentBaseClasses = 'fixed bg-background border-border shadow-2xl focus:outline-none flex flex-col transition-[transform,opacity] duration-base ease-smooth motion-reduce:transition-none';
