...
export const checkoutTicketSchema = z
  .object({
...
export const checkoutSchema = z
  .object({
    ...
    guestName: z
      ...
      .max(200, "Guest name is too long"),
    guestEmail: z
      .string()
    ...
    couponCode: z.string().toUpperCase().trim().max(50).optional(),
  })
  .strict();

export const reserveTicketsSchema = z
  .object({
    eventId: objectIdSchema,
    tickets: z
      .array(checkoutTicketSchema)
...
export const checkoutDetailsSchema = z
  .object({
    ...
    guestEmailConfirm: z
      .string()
      .email("Invalid email confirmation format")
      .max(200, "Confirmation email is too long"),
    guestPhone: z
      .string()
      .min(8, "Invalid phone number format")
      .max(50, "Phone number is too long"),
  ...
  .strict()
  .refine((data) => data.guestEmail === data.guestEmailConfirm, {
...
export const adminDlqRetrySchema = z
  .object({
