...
const compact = (parts: QueryKeyPart[]) =>
...
export const QUERY_KEYS = {
  public: {
    events: {
      ...
      list: (filters: Record<string, unknown> = {}) =>
        ["public-events", filters] as const,
      featured: () => ["featured-events"] as const,
      detail: (slug?: string) =>
        compact(["public-event", slug]) as readonly QueryKeyPart[],
      seats: (eventId?: string) =>
        compact(["public-event-seats", eventId]) as readonly QueryKeyPart[],
    },
    bookings: {
  ...
  admin: {
    ...
    bookings: {
      ...
      detail: (id?: string) =>
        compact(["admin-booking", id]) as readonly QueryKeyPart[],
    },
    events: {
      ...
      detail: (id?: string) =>
        compact(["admin-event", id]) as readonly QueryKeyPart[],
    },
    refunds: {
    ...
    diagnostics: {
      ...
      reservations: (status?: string) =>
        compact([
          "admin-diagnostics-reservations",
          status,
        ]) as readonly QueryKeyPart[],
    },
    coupons: {
      all: ["admin-coupons"] as const,
      list: (page?: number, active?: string) =>
        compact(["admin-coupons", page, active]) as readonly QueryKeyPart[],
      detail: (id?: string) =>
        compact(["admin-coupon", id]) as readonly QueryKeyPart[],
    },
    popups: {
      all: ["admin-popups"] as const,
      list: (page?: number) =>
        compact(["admin-popups", page]) as readonly QueryKeyPart[],
      detail: (id?: string) =>
        compact(["admin-popup", id]) as readonly QueryKeyPart[],
    },
    venues: {
      all: ["admin-venues"] as const,
      list: (filters: Record<string, unknown> = {}) =>
        ["admin-venues", filters] as const,
      detail: (id?: string) =>
        compact(["admin-venue", id]) as readonly QueryKeyPart[],
    },
    artists: {
      all: ["admin-artists"] as const,
      list: (filters: Record<string, unknown> = {}) =>
        ["admin-artists", filters] as const,
      detail: (id?: string) =>
        compact(["admin-artist", id]) as readonly QueryKeyPart[],
    },
    djs: {
      all: ["admin-djs"] as const,
      list: (filters: Record<string, unknown> = {}) =>
        ["admin-djs", filters] as const,
      detail: (id?: string) =>
        compact(["admin-dj", id]) as readonly QueryKeyPart[],
    },
    team: {
      all: ["admin-team"] as const,
      list: (page?: number) =>
        compact(["admin-team", page]) as readonly QueryKeyPart[],
