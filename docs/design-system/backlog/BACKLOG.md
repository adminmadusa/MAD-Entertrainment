...
|---|---|---|---|---|---|
| BL-001 | `Pagination` primitive in `@mad/ui` | `UX-FORM-005` | high | Resolved | `2.1.0` |
| BL-002 | `SearchInput` primitive in `@mad/ui` | `UX-FORM-002` | medium | Resolved | `2.1.0` |
| BL-003 | `DateRangePicker` primitive in `@mad/ui` | `UX-FORM-003` | medium | Open | — |
| BL-005 | `NumericStepper` primitive in `@mad/ui` | `UX-BOOK-001` | medium | Resolved | `2.1.0` |
...
**Priority:** High
**Status:** Resolved
**Resolved In:** `packages/ui/src/composites/Pagination`
...
**Priority:** Medium
**Status:** Resolved
**Resolved In:** `packages/ui/src/composites/SearchInput`
